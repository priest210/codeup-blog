...
<body>
		...
		<div class="container">
			...
			<div class="nav-collapse collapse navbar-responsive-collapse">
				<ul class="nav row">
					...
					<li data-slide="3" class="col-12 col-sm-2"><a id="menu-link-3" href="#slide-3" title="Next Section"><span class="icon icon-briefcase"></span> <span class="text">Resume</span></a></li>
					...
					<li data-slide="6" class="col-12 col-sm-2"><a id="menu-link-6" href="#slide-6" title="Next Section"><span class="icon icon-envelope"></span> <span class="text">Contact Me</span></a></li>
				</ul>
				<div class="row">
	...
	<div class="slide story" id="slide-3" data-slide="3">
		<div class="row">
			<div class="col-12 col-sm-6 col-lg-2"><a data-fancybox-group="portfolio" class="fancybox" href="/Munter/Theme/images/portfolio/LCP.png"><img class="thumb" src="/Munter/Theme/images/portfolio/LCP.png" alt=""></a></div>
			<div class="col-12 col-sm-6 col-lg-2"><a data-fancybox-group="portfolio" class="fancybox" href="/Munter/Theme/images/portfolio/whack.png"><img class="thumb" src="/Munter/Theme/images/portfolio/whack.png" alt=""></a></div>
			<div class="col-12 col-sm-6 col-lg-2"><a data-fancybox-group="portfolio" class="fancybox" href="/Munter/Theme/images/portfolio/digitalResume.png"><img class="thumb" src="/Munter/Theme/images/portfolio/digitalResume.png" alt=""></a></div>
		</div><!-- /row -->
	</div><!-- /slide3 -->
